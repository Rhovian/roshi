...
/// atomically replaces the mutable settings (oracle, enabled). Immutable fields
/// (vault, asset mint, decimals) and the derived custody account are preserved;
/// the replacement is validated on store.
